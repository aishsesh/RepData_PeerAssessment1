...
```
The interval with maximum number of steps on average across all days is `r maxInterval`
...
```
We can see that there are `r numMissing` missing values in the steps column in the given data set.
